...
public class TestRoyaleMXMLUint extends RoyaleTestBase
{
    ...
    public void testUintTag()
    {
        String code = "<fx:Declarations>\n"
				+ "\t<fx:uint id=\"unsignedInteger\">4294967295</fx:uint>\n"
				+ "</fx:Declarations>";
    ...
    {
        String code = "<fx:Declarations>\n"
				+ "\t<basic:TextFieldItemRenderer downColor=\"4294967295\"/>\n"
				+ "</fx:Declarations>";
        ...
        String outTemplate = "/**\n" +
            ...
            "  /**\n" +
            "   * @private\n" +
            "   * @type {org.apache.royale.html.supportClasses.TextFieldItemRenderer}\n" +
            "   */\n" +
            "  this.$ID_8_0;\n" +
            "  \n" +
            "  /**\n" +
