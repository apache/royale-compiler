        ...
        IMXMLRoyaleEmitter, IMXMLJSEmitter
{
    ...
    void emitEventOverride(IMXMLEventSpecifierNode eventNode)
    {
        ...
        handler.value = formatQualifiedName(JSRoyaleEmitterTokens.LANGUAGE_QNAME.getToken())
                ...
                + ASEmitterTokens.MEMBER_ACCESS.getToken()
                + eventHandler + ASEmitterTokens.COMMA.getToken() + ASEmitterTokens.SPACE.getToken()
                + ASEmitterTokens.THIS.getToken() + ASEmitterTokens.COMMA.getToken() + ASEmitterTokens.SPACE.getToken()
                + ASEmitterTokens.SINGLE_QUOTE.getToken() + eventHandler + ASEmitterTokens.SINGLE_QUOTE.getToken()
