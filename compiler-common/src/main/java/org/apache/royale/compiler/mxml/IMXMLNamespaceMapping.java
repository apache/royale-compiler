 ...
 */
public interface IMXMLNamespaceMapping
{
    /**
     * Returns the MXML namespace URI of the mapping.
     * 
     * @return the MXML namespace URI of the mapping.
     */
    String getURI();
     ...
     * mapping.
     * 
     * @return the normalized absolute file name to the manifest file of the
     * mapping.
     */
