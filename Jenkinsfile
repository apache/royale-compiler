        ...
        stage 'Build Royale Framework'
            ...
            dir('framework') {
                ...
                withEnv(["MAVEN_OPTS=-XX:MaxPermSize=256m"]) {
                    bat "mvn -U -X clean ${mavenGoal} ${mavenLocalRepo} -s C:\\.m2\\settings.xml -P apache-snapshots-enabled,build-examples -Dcom.adobe.systemIdsForWhichTheTermsOfTheAdobeLicenseAgreementAreAccepted=3872fc1e"
                }
            }
