 ...
 */
public class BinaryOperatorMinusNode extends BinaryOperatorNodeBase
{
    /**
     * Constructor.
     */
    public BinaryOperatorMinusNode(IASToken operatorToken,
     ...
     */
    protected BinaryOperatorMinusNode(BinaryOperatorMinusNode other)
    {
        super(other);
    }
    ...
    @Override
    protected BinaryOperatorMinusNode copy()
    {
        return new BinaryOperatorMinusNode(this);
    }
