...
public class StateGroupDefinition extends StateDefinitionBase implements IStateGroupDefinition
{
    ...
    /**
     * A map mapping state names to {@code IStateDefinition} objects.
     * This is effectively the set of states included in this group,
     * but we use a map because we're interested in this set
     * both as a set of state names (the String keys)
     * and a set of state objects (the {@code IStateDefinition} values).
     */
