...
public interface IMXMLTypeConstants
{
    ...
    public final Namespace NAMESPACE_MX_INTERNAL =
    ...
    public final Object[] ADD_EVENT_LISTENER_CALL_OPERANDS = new Object[] { new Name("addEventListener"), 2 };
    public final Object[] ADD_LAYER_CALL_OPERANDS = new Object[] {new Name("addLayer"), 1};
    public final Object[] CREATE_XML_DOCUMENT_CALL_OPERANDS = new Object[]{ new Name("createXMLDocument"), 1 };
    public final Object[] EXECUTE_BINDINGS_CALL_OPERANDS = new Object[] { new Name("executeBindings"), 3 };
    public final Object[] GET_INSTANCE_CALL_OPERANDS = new Object[] { new Name("getInstance"), 0 };
    public final Object[] INITIALIZE_CALL_OPERANDS = new Object[] { new Name("initialize"), 0 };
    public final Object[] INITIALIZED_CALL_OPERANDS = new Object[] { new Name("initialized"), 2 };
    ...
    // AET operands for calling runtime methods.
    public final Object[] ARG_UPDATEPARENT = new Object[] { new Name("updateParent"), 1};
    ...
    public final Name NAME_ARRAYINDEXPROP = new Name(ABCConstants.CONSTANT_MultinameL, 
            new Nsset(new Namespace(CONSTANT_PackageNs)),
            null);
