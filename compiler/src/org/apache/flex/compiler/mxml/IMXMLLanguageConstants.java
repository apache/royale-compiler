...
public interface IMXMLLanguageConstants
{
    ...
    /**
     * The short name of the tag representing the ActionScript <code>Array</code> type.
     */
	static final String ARRAY = IASLanguageConstants.Array;

    /**
     * The short name of the tag representing the ActionScript <code>Boolean</code> type.
     */
    static final String BOOLEAN = IASLanguageConstants.Boolean;

    /**
     * The short name of the tag representing the ActionScript <code>Class</code> type.
     */
    static final String CLASS = IASLanguageConstants.Class;

    /**
     * The short name of the tag representing the ActionScript <code>Date</code> type.
     */
    static final String DATE = IASLanguageConstants.Date;

    /**
     * The short name of the tag representing the ActionScript <code>Function</code> type.
     */
    static final String FUNCTION = IASLanguageConstants.Function;

    /**
     * The short name of the tag representing the ActionScript <code>int</code> type.
     */
    static final String INT = IASLanguageConstants._int;
 
    /**
     * The short name of the tag representing the ActionScript <code>Number</code> type.
     */
    static final String NUMBER = IASLanguageConstants.Number;
    
    /**
     * The short name of the tag representing the ActionScript <code>Object</code> type.
     */
    static final String OBJECT = IASLanguageConstants.Object;
    
    /**
     * The short name of the tag representing the ActionScript <code>uint</code> type.
     */
    ...
    /**
     * The short name of the tag representing the ActionScript <code>XML</code> type.
     */
    static final String XML = IASLanguageConstants.XML;
    
    /**
     * The short name of the tag representing the ActionScript <code>XMLList</code> type.
     */
    ...
    /**
     * The short name of the special <code>itemDestructionPolicy</code> attribute.
     */
    ...
    /**
     * The short name of the special <code>scriptRecursionLimit</code> attribute.
     */
	...
	/**
	 * One of the two allowed values for the <code>itemCreationPolicy</code> attribute.
	 */
    ...
    /**
     * One of the two allowed values for the <code>itemDestructionPolicy</code> attribute.
     */
    ...
    /**
     * The name of the autogenerated <code>outerDocument</code> property
     * of a {@code <Component>} class.
     */
