...
/**
 * This is a grammar for ActionScript.
 */
grammar AS;
...
/*{
    ...
    :   { _input.LA(1) == TOKEN_BLOCK_OPEN }? groupDirective[c, endToken]
    |   { _input.LA(1) == TOKEN_RESERVED_WORD_NAMESPACE && _input.LA(2) == TOKEN_PAREN_OPEN }? statement[c, endToken]
    |   { _input.LA(1) == TOKEN_IDENTIFIER && _input.LA(2) == TOKEN_NAMESPACE_ANNOTATION && _input.LT(1).getLine() == _input.LT(2).getLine() }?
        // Skip over the user-defined namespace name and continue.
        /*nsT:*/TOKEN_IDENTIFIER attributedDefinition[c] /*{ trapInvalidNamespaceAttribute((ASToken)nsT); }*/
    |   asDocComment
    |   importDirective[c]
    |   useNamespaceDirective[c] 
    |   { _input.LA(1) == TOKEN_NAMESPACE_NAME &&
    	  _input.LA(2) == TOKEN_OPERATOR_NS_QUALIFIER &&
    	  _input.LA(3) == TOKEN_IDENTIFIER &&
    	  _input.LA(4) == TOKEN_BLOCK_OPEN}?
        // ns::var { ... }
        groupDirectiveWithConfigVariable[c, endToken]
    |   { _input.LA(1) == TOKEN_NAMESPACE_NAME &&
    	  _input.LA(2) == TOKEN_OPERATOR_NS_QUALIFIER &&
    	  _input.LA(3) == TOKEN_NAMESPACE_ANNOTATION }?
...
/*{
    ...
    |   gotoStatement[c]                 
    |   emptyStatement
    |   { _input.LA(1) == TOKEN_IDENTIFIER && _input.LA(2) == TOKEN_COLON }? labeledStatement[c, exitCondition]
    |   { _input.LA(1) != TOKEN_SQUARE_OPEN &&
    	  _input.LA(1) != TOKEN_OPERATOR_LESS_THAN &&
    	  _input.LA(1) != TOKEN_BLOCK_OPEN }? expressionStatement[c]
    |   forStatement[c]
    |   ifStatement[c]
    |   meta[c]
    |   returnStatement[c]
...
substatement[ContainerNode c]
    :   (   { _input.LA(1) != TOKEN_BLOCK_OPEN }? statement[c, -1]
        |   block[c] 
...
/*{
    ...
    :   /*labelT:*/TOKEN_IDENTIFIER TOKEN_COLON
        ...
        (   { _input.LA(1) == TOKEN_RESERVED_WORD_NAMESPACE && _input.LA(2) == TOKEN_IDENTIFIER }?
...
/*{
    ...
    :   /*useT:*/YeTOKEN_KEYWORD_USE /*{ u = new UseNamespaceNode(n); u.startBefore(useT); c.addItem(u); }*/
...
/*{
	...
	ExpressionNodeBase e = null; 
 	...
 	:	/*n=*/identifier
		(options{greedy=true;}: { _input.LA(2) != TOKEN_OPERATOR_STAR }?
			/*dotT:*/TOKEN_OPERATOR_MEMBER_ACCESS
			/*{
...
/*{
    ...
    :   { _input.LA(1) == TOKEN_BLOCK_OPEN }? /*lbT:*/TOKEN_BLOCK_OPEN
...
/*{
	...
	:   (   /*functionT:*/TOKEN_KEYWORD_FUNCTION
	        ...
	        (options{greedy=true;}:
	        	{ _input.LA(2) != TOKEN_PAREN_OPEN}? /*getT:*/TOKEN_RESERVED_WORD_GET
        	|   { _input.LA(2) != TOKEN_PAREN_OPEN}? /*setT:*/TOKEN_RESERVED_WORD_SET
        	)? 
 ...
 *
 */
restrictedName returns [ExpressionNodeBase ne]
/*{
    nameExpression = null;
    ...
    :   /*nameExpression=*/restrictedNamePart
        ...
        (options { greedy=true; }: { _input.LA(2) != TOKEN_PAREN_OPEN }?
            /*{
                opToken = LT(1); 
            ...
            (	{ opToken.getType() == TOKEN_OPERATOR_NS_QUALIFIER && _input.LA(1) == TOKEN_SQUARE_OPEN }?
...
/*{
    ...
    :   (   { isConfigCondition() && _input.LA(4) != TOKEN_COLON && _input.LA(4) != TOKEN_BLOCK_CLOSE }?
...
/*{
    ...
    :   ( TOKEN_COMMA /*{ b.addItem(new NilNode()); }*/ )*
        (   { _input.LA(1) != TOKEN_SQUARE_CLOSE}?
            	/*e=*/arrayElement /*{ b.addItem(e); }*/
                (   TOKEN_COMMA 
                    (   { _input.LA(1) != TOKEN_SQUARE_CLOSE && _input.LA(1) != TOKEN_COMMA }? /*e=*/arrayElement /*{ b.addItem(e); }*/

                    |   { _input.LA(1) != TOKEN_SQUARE_CLOSE && _input.LA(1) == TOKEN_COMMA }? /*{ b.addItem(new NilNode()); }*/
                    |   // Next token is "]" - pass.
            	 	)
//             		exception catch [RecognitionException ex] { handleParsingError(ex); }
              	)*
...
/*{
    ...
    :   (   { isConfigCondition() && _input.LA(4) != TOKEN_COMMA && _input.LA(4) != TOKEN_SQUARE_CLOSE }?
            c=configCondition
        |   // Skip - no config varaible.
        )
...
/*{
    ...
    :   { _input.LA(1) == TOKEN_E4X_COMMENT ||
    	  _input.LA(1) == TOKEN_E4X_CDATA ||
    	  _input.LA(1) == TOKEN_E4X_PROCESSING_INSTRUCTION
    	}? 
        xmlMarkup
...
/*{
	...
	:   /*newT:*/TOKEN_KEYWORD_NEW
        (   { _input.LA(1) != TOKEN_KEYWORD_FUNCTION }?
