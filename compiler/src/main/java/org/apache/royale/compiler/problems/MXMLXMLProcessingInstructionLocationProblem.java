...
/**
 * Problem generated when the {@code <?xml?>} processing instruction
...
public final class MXMLXMLProcessingInstructionLocationProblem extends MXMLSyntaxProblem
{
    public static final String DESCRIPTION =
        "The <?${XML}?> processing instruction, if present, should be at the beginning of the file.";

    public static final int errorCode = 1453;
