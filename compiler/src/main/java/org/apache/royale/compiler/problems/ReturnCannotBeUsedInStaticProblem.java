 ...
 */
public final class ReturnCannotBeUsedInStaticProblem extends SemanticProblem
{
    public static final String DESCRIPTION =
        "The ${RETURN} statement cannot be used in static initialization code.";

    public static final int errorCode = 1149;

    public ReturnCannotBeUsedInStaticProblem(IASNode site)
    {
        super(site);
    }
