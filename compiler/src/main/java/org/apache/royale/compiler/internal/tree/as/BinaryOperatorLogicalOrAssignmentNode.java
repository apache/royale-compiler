 ...
 */
public final class BinaryOperatorLogicalOrAssignmentNode extends BinaryOperatorLogicalOrNode
    implements ICompoundAssignmentNode
{
    /**
     * Constructor.
     */
    public BinaryOperatorLogicalOrAssignmentNode(IASToken operatorToken,
     ...
     */
    protected BinaryOperatorLogicalOrAssignmentNode(BinaryOperatorLogicalOrAssignmentNode other)
    {
        super(other);
    }
    ...
    {
        return ASTNodeID.Op_LogicalOrAssignID;
    }
    ...
    @Override
    protected BinaryOperatorLogicalOrAssignmentNode copy()
    {
        return new BinaryOperatorLogicalOrAssignmentNode(this);
    }
    ...
    {
        return OperatorType.LOGICAL_OR_ASSIGNMENT;
    }
