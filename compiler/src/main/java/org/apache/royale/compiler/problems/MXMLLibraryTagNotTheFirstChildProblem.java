 ...
 */
public final class MXMLLibraryTagNotTheFirstChildProblem extends MXMLSemanticProblem
{
    public static final String DESCRIPTION =
        "${LIBRARY} tag must be the first child inside a tag that defines a class.";
