 ...
 */
public final class ReturnValueMustBeUndefinedProblem extends StrictSemanticsProblem
{
    public static final String DESCRIPTION =
        "A return value is not allowed because the return type of this function is '${VOID}'.";

    public static final int errorCode = 1051;

    public ReturnValueMustBeUndefinedProblem(IASNode site)
    {
        super(site);
    }
