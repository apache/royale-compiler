 ...
 */
public final class InvalidPrivateNamespaceAttrProblem extends SemanticProblem
{
    public static final String DESCRIPTION =
        "The ${PRIVATE} attribute may be used only on ${CLASS} property definitions.";

    public static final int errorCode = 1013;

    public InvalidPrivateNamespaceAttrProblem(IASNode site)
    {
        super(site);
    }
