 ...
 */
public final class StaticNamespaceDefinitionProblem extends CodegenProblem
{
    public static final String DESCRIPTION =
        "The ${STATIC} attribute is not allowed on ${NAMESPACE} definitions.";

    public static final int errorCode = 1192;

    public StaticNamespaceDefinitionProblem(IASNode site)
    {
        super(site);
    }
