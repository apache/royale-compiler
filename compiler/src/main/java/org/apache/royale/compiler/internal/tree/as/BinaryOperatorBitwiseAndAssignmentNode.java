 ...
 */
public final class BinaryOperatorBitwiseAndAssignmentNode extends BinaryOperatorBitwiseAndNode
    implements ICompoundAssignmentNode
{
    /**
     * Constructor.
     */
    public BinaryOperatorBitwiseAndAssignmentNode(IASToken operatorToken,
     ...
     */
    protected BinaryOperatorBitwiseAndAssignmentNode(BinaryOperatorBitwiseAndAssignmentNode other)
    {
        super(other);
    }
    ...
    {
        return ASTNodeID.Op_BitwiseAndAssignID;
    }
    
    //
    // ExpresionNode overrides
    //
    ...
    @Override
    protected BinaryOperatorBitwiseAndAssignmentNode copy()
    {
        return new BinaryOperatorBitwiseAndAssignmentNode(this);
    }
