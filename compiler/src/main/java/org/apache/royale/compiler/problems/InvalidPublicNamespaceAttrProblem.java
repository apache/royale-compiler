 ...
 */
public final class InvalidPublicNamespaceAttrProblem extends SemanticProblem
{
    public static final String DESCRIPTION =
        "The ${PUBLIC} attribute can only be used inside a ${PACKAGE}.";

    public static final int errorCode = 1114;

    public InvalidPublicNamespaceAttrProblem(IASNode site)
    {
        super(site);
    }
