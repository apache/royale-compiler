 ...
 */
public final class BinaryOperatorDivisionAssignmentNode extends BinaryOperatorDivisionNode
    implements ICompoundAssignmentNode
{
    /**
     * Constructor.
     */
    public BinaryOperatorDivisionAssignmentNode(IASToken operatorToken,
     ...
     */
    protected BinaryOperatorDivisionAssignmentNode(BinaryOperatorDivisionAssignmentNode other)
    {
        super(other);
    }
    ...
    {
        return ASTNodeID.Op_DivideAssignID;
    }
    ...
    @Override
    protected BinaryOperatorDivisionAssignmentNode copy()
    {
        return new BinaryOperatorDivisionAssignmentNode(this);
    }

    //
    // OpeartorNodeBase overrides
    //
