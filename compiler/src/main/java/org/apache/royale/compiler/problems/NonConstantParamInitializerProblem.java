 ...
 */
public final class NonConstantParamInitializerProblem extends SemanticProblem
{
    ...
    public static final int errorCode = 1047;

    public NonConstantParamInitializerProblem(IASNode site)
    {
        super(site);
    }
}
