...
public final class UnboundMetadataProblem extends ParserProblem
{
    public static final String DESCRIPTION =
        "Metadata was not bound to a definition";

    public static final int warningCode = 1518;
    public UnboundMetadataProblem(TokenBase site)
    {
        super(site);
    }
}
