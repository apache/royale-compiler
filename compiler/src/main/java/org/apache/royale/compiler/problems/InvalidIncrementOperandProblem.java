 ...
 */
public final class InvalidIncrementOperandProblem extends SemanticProblem
{
    public static String DESCRIPTION =
        "Increment operand is invalid.";
    
    public static final int errorCode = 1107;

    public InvalidIncrementOperandProblem(IASNode site)
    {
        super(site);
    }
}
