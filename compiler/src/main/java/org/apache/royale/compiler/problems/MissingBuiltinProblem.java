...
public final class MissingBuiltinProblem extends FatalProblem
{
    public static final String DESCRIPTION =
        "Missing builtin type ${builtinType}";

    public static final int errorCode = 1475;
    
    public MissingBuiltinProblem(IASNode site, String type)
    {
        super(site);
        this.builtinType = type;
    }

    public MissingBuiltinProblem(String type)
    {
        super();
        this.builtinType = type;
    }
