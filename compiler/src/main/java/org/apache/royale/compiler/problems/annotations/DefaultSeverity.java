 ...
 * overridden by the user at compile time by using compiler options. See the
 * below compiler options to override a problem's severity: 
 *     -error-problems
 *     -warning-problems
 *     -ignore-problems
 */
