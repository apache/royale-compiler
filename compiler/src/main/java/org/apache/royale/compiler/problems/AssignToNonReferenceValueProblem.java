 ...
 */
public final class AssignToNonReferenceValueProblem extends StrictSemanticsProblem
{
    public static final String DESCRIPTION =
        "Cannot assign to a non-reference value.";

    public static final int errorCode = 1050;

    public AssignToNonReferenceValueProblem(IASNode site)
    {
        super(site);
    }
}
