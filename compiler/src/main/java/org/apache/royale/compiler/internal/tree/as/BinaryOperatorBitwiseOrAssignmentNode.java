 ...
 */
public final class BinaryOperatorBitwiseOrAssignmentNode extends BinaryOperatorBitwiseOrNode
    implements ICompoundAssignmentNode
{
    /**
     * Constructor.
     */
    public BinaryOperatorBitwiseOrAssignmentNode(IASToken operatorToken,
     ...
     */
    protected BinaryOperatorBitwiseOrAssignmentNode(BinaryOperatorBitwiseOrAssignmentNode other)
    {
        super(other);
    }
    ...
    {
        return ASTNodeID.Op_BitwiseOrAssignID;
    }
    ...
    @Override
    protected BinaryOperatorBitwiseOrAssignmentNode copy ()
    {
        return new BinaryOperatorBitwiseOrAssignmentNode(this);
    }
