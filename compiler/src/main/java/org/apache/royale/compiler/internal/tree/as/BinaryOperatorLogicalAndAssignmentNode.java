 ...
 */
public final class BinaryOperatorLogicalAndAssignmentNode extends BinaryOperatorLogicalAndNode
    implements ICompoundAssignmentNode
{
    /**
     * Constructor.
     */
    public BinaryOperatorLogicalAndAssignmentNode(IASToken operatorToken,
     ...
     */
    protected BinaryOperatorLogicalAndAssignmentNode(BinaryOperatorLogicalAndAssignmentNode other)
    {
        super(other);
    }
    ...
    {
        return ASTNodeID.Op_LogicalAndAssignID;
    }
    ...
    @Override
    protected BinaryOperatorLogicalAndAssignmentNode copy()
    {
        return new BinaryOperatorLogicalAndAssignmentNode(this);
    }
    ...
    {
        return OperatorType.LOGICAL_AND_ASSIGNMENT;
    }
