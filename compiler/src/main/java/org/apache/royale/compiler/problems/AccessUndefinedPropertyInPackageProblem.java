 ...
 */
public final class AccessUndefinedPropertyInPackageProblem extends StrictSemanticsProblem
{
    public static final String DESCRIPTION =
        "Access of undefined property ${propertyName} in ${PACKAGE} ${packageName}.";

    public static final int errorCode = 1202;

    public AccessUndefinedPropertyInPackageProblem(IASNode site, String propertyName, String packageName)
    {
        super(site);
