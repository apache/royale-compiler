 ...
 */
public final class RequiredParameterAfterOptionalProblem extends SemanticProblem
{
    public static final String DESCRIPTION =
        "Required parameters are not permitted after optional parameters.";

    public static final int errorCode = 1138;

    public RequiredParameterAfterOptionalProblem(IASNode site)
    {
        super(site);
    }
}
