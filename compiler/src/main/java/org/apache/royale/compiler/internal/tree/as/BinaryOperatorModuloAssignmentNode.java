 ...
 */
public final class BinaryOperatorModuloAssignmentNode extends BinaryOperatorModuloNode
    implements ICompoundAssignmentNode
{
    /**
     * Constructor.
     */
    public BinaryOperatorModuloAssignmentNode(IASToken operatorToken,
     ...
     */
    protected BinaryOperatorModuloAssignmentNode(BinaryOperatorModuloAssignmentNode other)
    {
        super(other);
    }
    ...
    {
        return ASTNodeID.Op_ModuloAssignID;
    }
    ...
    @Override
    protected BinaryOperatorModuloAssignmentNode copy()
    {
        return new BinaryOperatorModuloAssignmentNode(this);
    }
    ...
    {
        return OperatorType.MODULO_ASSIGNMENT;
    }
