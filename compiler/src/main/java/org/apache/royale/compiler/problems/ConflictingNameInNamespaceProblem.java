...
public final class ConflictingNameInNamespaceProblem extends SemanticProblem
{
    public static final String DESCRIPTION =
        "A conflict exists with definition ${declName} in namespace ${nsName}.";

    public static final int errorCode = 1151;

    public ConflictingNameInNamespaceProblem(IASNode site, String declName, String nsName)
    {
        super(site);
