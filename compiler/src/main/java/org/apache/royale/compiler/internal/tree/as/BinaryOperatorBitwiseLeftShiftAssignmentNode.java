 ...
 */
public final class BinaryOperatorBitwiseLeftShiftAssignmentNode extends BinaryOperatorBitwiseLeftShiftNode
    implements ICompoundAssignmentNode
{
    /**
     * Constructor.
     */
    public BinaryOperatorBitwiseLeftShiftAssignmentNode(IASToken operatorToken,
     ...
     */
    protected BinaryOperatorBitwiseLeftShiftAssignmentNode(BinaryOperatorBitwiseLeftShiftAssignmentNode other)
    {
        super(other);
    }
    ...
    {
        return ASTNodeID.Op_LeftShiftAssignID;
    }
    
    //
    // ExprsessionNode overrides
    //
    ...
    @Override
    protected BinaryOperatorBitwiseLeftShiftAssignmentNode copy()
    {
        return new BinaryOperatorBitwiseLeftShiftAssignmentNode(this);
    }
