...
public abstract class FontManager
{
     ...
     */
    public DefineFontTag createDefineFont(int tagCode, FontDescription desc)
    {
        // No op
        return null;
    }
     ...
     * @param tag The DefineFont tag.
     */
    public void loadDefineFont(DefineFontTag tag)
    {
    ...
    public static final class EmbedAsCffNotSupportedException extends RuntimeException
    {
        public EmbedAsCffNotSupportedException()
        {
        }
    }

    public static final class SystemFontNotSupportedException extends RuntimeException
    {
        public SystemFontNotSupportedException()
        {
        }
    }
}
