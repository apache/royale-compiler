...
/**
 * {@link ICompilerProblem} implementation instantiated when the root class
 * of an application SWF can not be found.
 */
public final class UnableToFindRootClassDefinitionProblem extends CompilerProblem
{
    public static final String DESCRIPTION = "Unable to resolve root class of SWF: ${rootClassName}";
    public static final int errorCode = 5030;
