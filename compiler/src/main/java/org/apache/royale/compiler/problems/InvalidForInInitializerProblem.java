...
public final class InvalidForInInitializerProblem extends SemanticProblem
{
    public static final String DESCRIPTION =
        "invalid for-in initializer, only 1 expression expected.";

    public static final int errorCode = 1200;
    
    public InvalidForInInitializerProblem(IASNode site)
    {
        super(site);
    }
}
