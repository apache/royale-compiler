...
public final class MissingCatchOrFinallyProblem extends SemanticProblem
{
    public static final String DESCRIPTION =
        "expecting a ${CATCH} or a ${FINALLY} clause.";

    public static final int errorCode = 1073;
    
    public MissingCatchOrFinallyProblem(IASNode site)
    {
        super(site);
    }
    ...
    public final String FINALLY = "finally";
}
