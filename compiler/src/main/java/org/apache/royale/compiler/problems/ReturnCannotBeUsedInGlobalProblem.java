 ...
 */
public final class ReturnCannotBeUsedInGlobalProblem extends SemanticProblem
{
    public static final String DESCRIPTION =
        "The ${RETURN} statement cannot be used in global initialization code.";

    public static final int errorCode = 1177;

    public ReturnCannotBeUsedInGlobalProblem(IASNode site)
    {
        super(site);
    }
