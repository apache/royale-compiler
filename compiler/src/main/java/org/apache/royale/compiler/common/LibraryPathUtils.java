...
public class LibraryPathUtils
{
    ...
    {
        return LibraryPathManager.isSWCFile(file);
    }
    
    public static String getAttachedSourceFilename(String sourceDirectory, String qualifiedName) 
    {
        return LibraryPathManager.getAttachedSourceFilename(sourceDirectory, qualifiedName);
    }
    
    public static String getDotSWCExt()
    {
        return LibraryPathManager.DOT_SWC_EXT;
    }

    public static String getSWCExt()
    {
        return LibraryPathManager.SWC_EXT;
    }
}
