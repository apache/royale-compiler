 ...
 */
public final class BinaryOperatorBitwiseRightShiftAssignmentNode extends BinaryOperatorBitwiseRightShiftNode
    implements ICompoundAssignmentNode
{
    /**
     * Constructor.
     */
    public BinaryOperatorBitwiseRightShiftAssignmentNode(IASToken operatorToken,
     ...
     */
    protected BinaryOperatorBitwiseRightShiftAssignmentNode(BinaryOperatorBitwiseRightShiftAssignmentNode other)
    {
        super(other);
    }
    ...
    {
        return ASTNodeID.Op_RightShiftAssignID;
    }
    ...
    @Override
    protected BinaryOperatorBitwiseRightShiftAssignmentNode copy()
    {
        return new BinaryOperatorBitwiseRightShiftAssignmentNode(this);
    }
