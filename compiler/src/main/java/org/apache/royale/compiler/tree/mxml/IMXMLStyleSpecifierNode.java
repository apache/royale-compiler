 ...
 * <p>
 * An {@link IMXMLStyleSpecifierNode} has exactly one child node: an
 * {@link IMXMLInstanceNode} representing the property value. For a simple
 * scalar style such as one of type <code>String</code>, this will be an
 * {@link IMXMLStringNode}.
 */
public interface IMXMLStyleSpecifierNode extends IMXMLPropertySpecifierNode
{
}
