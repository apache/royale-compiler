...
public final class CountedForLoopInitializerProblem extends SemanticProblem
{
    public static final String DESCRIPTION =
        "expecting semicolon before rightparen.";

    public static final int errorCode = 1084;
    
    public CountedForLoopInitializerProblem(IASNode site)
    {
        super(site);
    }
}
