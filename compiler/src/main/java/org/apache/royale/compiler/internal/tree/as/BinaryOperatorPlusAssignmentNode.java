 ...
 */
public final class BinaryOperatorPlusAssignmentNode extends BinaryOperatorPlusNode
    implements ICompoundAssignmentNode
{
    /**
     * Constructor.
     */
    public BinaryOperatorPlusAssignmentNode(IASToken operatorToken,
     ...
     */
    protected BinaryOperatorPlusAssignmentNode(BinaryOperatorPlusAssignmentNode other)
    {
        super(other);
    }
    ...
    {
        return ASTNodeID.Op_AddAssignID;
    }
    ...
    @Override
    protected BinaryOperatorPlusAssignmentNode copy()
    {
        return new BinaryOperatorPlusAssignmentNode(this);
    }
    ...
    {
        return OperatorType.PLUS_ASSIGNMENT;
    }
