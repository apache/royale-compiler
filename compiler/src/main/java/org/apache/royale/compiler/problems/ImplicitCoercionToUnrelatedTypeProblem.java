 ...
 */
public final class ImplicitCoercionToUnrelatedTypeProblem extends StrictSemanticsProblem
{
    public static final String DESCRIPTION =
        "Implicit coercion of a value of type ${actualType} to an unrelated type ${expectedType}.";

    public static final int errorCode = 1067;

    public ImplicitCoercionToUnrelatedTypeProblem(IASNode site, String actualType, String expectedType)
    {
        super(site);
