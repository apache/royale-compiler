 ...
 */
public final class BinaryOperatorMinusAssignmentNode extends BinaryOperatorMinusNode
    implements ICompoundAssignmentNode
{
    /**
     * Constructor.
     */
    public BinaryOperatorMinusAssignmentNode(IASToken operatorToken,
     ...
     */
    protected BinaryOperatorMinusAssignmentNode(BinaryOperatorMinusAssignmentNode other)
    {
        super(other);
    }
    ...
    {
        return ASTNodeID.Op_SubtractAssignID;
    }
    ...
    @Override
    protected BinaryOperatorMinusAssignmentNode copy ()
    {
        return new BinaryOperatorMinusAssignmentNode(this);
    }
    ...
    {
        return OperatorType.MINUS_ASSIGNMENT;
    }
