 ...
 */
public final class BinaryOperatorMultiplicationAssignmentNode extends BinaryOperatorMultiplicationNode
    implements ICompoundAssignmentNode
{
    /**
     * Constructor.
     */
    public BinaryOperatorMultiplicationAssignmentNode(IASToken operatorToken,
     ...
     */
    protected BinaryOperatorMultiplicationAssignmentNode(BinaryOperatorMultiplicationAssignmentNode other)
    {
        super(other);
    }
    ...
    {
        return ASTNodeID.Op_MultiplyAssignID;
    }
    ...
    @Override
    protected BinaryOperatorMultiplicationAssignmentNode copy()
    {
        return new BinaryOperatorMultiplicationAssignmentNode(this);
    }
