 ...
 */
public class StreamingASTokenizer implements IASTokenizer, Closeable
{
    ...
    private static final Map<String, Integer> keywordToTokenMap = new ImmutableMap.Builder<String, Integer>()
            .put(IASKeywordConstants.AS, ASParser.TOKEN_KEYWORD_AS)
            .put(IASKeywordConstants.IS, ASParser.TOKEN_KEYWORD_IS)
            .put(IASKeywordConstants.INSTANCEOF, ASParser.TOKEN_KEYWORD_INSTANCEOF)
            .put(IASKeywordConstants.IN, ASParser.TOKEN_KEYWORD_IN)
            .put(IASKeywordConstants.DELETE, ASParser.TOKEN_KEYWORD_DELETE)
            .put(IASKeywordConstants.TYPEOF, ASParser.TOKEN_KEYWORD_TYPEOF)
            .put(IASKeywordConstants.CONST, ASParser.TOKEN_KEYWORD_CONST)
            .put(IASKeywordConstants.GET, ASParser.TOKEN_RESERVED_WORD_GET)
            .put(IASKeywordConstants.IMPLEMENTS, ASParser.TOKEN_RESERVED_WORD_IMPLEMENTS)
            .put(IASKeywordConstants.IMPORT, ASParser.TOKEN_KEYWORD_IMPORT)
            .put(IASKeywordConstants.USE, ASParser.TOKEN_KEYWORD_USE)
            .put(IASKeywordConstants.EXTENDS, ASParser.TOKEN_RESERVED_WORD_EXTENDS)
            .put(IASKeywordConstants.NEW, ASParser.TOKEN_KEYWORD_NEW)
            .put(IASKeywordConstants.DYNAMIC, ASParser.TOKEN_MODIFIER_DYNAMIC)
            .put(IASKeywordConstants.FINAL, ASParser.TOKEN_MODIFIER_FINAL)
            .put(IASKeywordConstants.NATIVE, ASParser.TOKEN_MODIFIER_NATIVE)
            .put(IASKeywordConstants.OVERRIDE, ASParser.TOKEN_MODIFIER_OVERRIDE)
            .put(IASKeywordConstants.STATIC, ASParser.TOKEN_MODIFIER_STATIC)
            .put(IASKeywordConstants.VIRTUAL, ASParser.TOKEN_MODIFIER_VIRTUAL)
            .put(IASKeywordConstants.SET, ASParser.TOKEN_RESERVED_WORD_SET)
            // Keywords with special token types that affect subsequent blocks
            .put(IASKeywordConstants.CATCH, ASParser.TOKEN_KEYWORD_CATCH)
            .put(IASKeywordConstants.CLASS, ASParser.TOKEN_KEYWORD_CLASS)
            .put(IASKeywordConstants.FUNCTION, ASParser.TOKEN_KEYWORD_FUNCTION)
            .put(IASKeywordConstants.INTERFACE, ASParser.TOKEN_KEYWORD_INTERFACE)
            .put(IASKeywordConstants.PACKAGE, ASParser.TOKEN_KEYWORD_PACKAGE)
            ...
            .put(IASKeywordConstants.VAR, ASParser.TOKEN_KEYWORD_VAR)
            .put(IASKeywordConstants.FALSE, ASParser.TOKEN_KEYWORD_FALSE)
            .put(IASKeywordConstants.NULL, ASParser.TOKEN_KEYWORD_NULL)
            .put(IASKeywordConstants.TRUE, ASParser.TOKEN_KEYWORD_TRUE)
            .put(IASKeywordConstants.PUBLIC, ASParser.HIDDEN_TOKEN_BUILTIN_NS)
            .put(IASKeywordConstants.PRIVATE, ASParser.HIDDEN_TOKEN_BUILTIN_NS)
            .put(IASKeywordConstants.PROTECTED, ASParser.HIDDEN_TOKEN_BUILTIN_NS)
            .put(IASKeywordConstants.INTERNAL, ASParser.HIDDEN_TOKEN_BUILTIN_NS)
            .put(IASKeywordConstants.INCLUDE, ASParser.TOKEN_KEYWORD_INCLUDE)
            // Keywords for statements that affect subsequent blocks
            .put(IASKeywordConstants.DO, ASParser.TOKEN_KEYWORD_DO)
            .put(IASKeywordConstants.WHILE, ASParser.TOKEN_KEYWORD_WHILE)
            .put(IASKeywordConstants.BREAK, ASParser.TOKEN_KEYWORD_BREAK)
            .put(IASKeywordConstants.CONTINUE, ASParser.TOKEN_KEYWORD_CONTINUE)
            .put(IASKeywordConstants.GOTO, ASParser.TOKEN_RESERVED_WORD_GOTO)
            .put(IASKeywordConstants.FOR, ASParser.TOKEN_KEYWORD_FOR)
            .put(StreamingASTokenizer.FOR_EACH, ASParser.TOKEN_KEYWORD_FOR)
            .put(IASKeywordConstants.EACH, ASParser.TOKEN_RESERVED_WORD_EACH)
            .put(IASKeywordConstants.WITH, ASParser.TOKEN_KEYWORD_WITH)
            .put(IASKeywordConstants.ELSE, ASParser.TOKEN_KEYWORD_ELSE)
            .put(IASKeywordConstants.IF, ASParser.TOKEN_KEYWORD_IF)
            .put(IASKeywordConstants.SWITCH, ASParser.TOKEN_KEYWORD_SWITCH)
            .put(IASKeywordConstants.CASE, ASParser.TOKEN_KEYWORD_CASE)
            .put(IASKeywordConstants.DEFAULT, ASParser.TOKEN_KEYWORD_DEFAULT)
            .put(IASKeywordConstants.TRY, ASParser.TOKEN_KEYWORD_TRY)
            .put(IASKeywordConstants.FINALLY, ASParser.TOKEN_KEYWORD_FINALLY)
            // Keywords with a generic keyword token type that have no effect 
            // on subsequent blocks.
            .put(IASKeywordConstants.NAMESPACE, ASParser.TOKEN_RESERVED_WORD_NAMESPACE)
            .put(IASKeywordConstants.CONFIG, ASParser.TOKEN_RESERVED_WORD_CONFIG)
            .put(IASKeywordConstants.THROW, ASParser.TOKEN_KEYWORD_THROW)
            .put(IASKeywordConstants.SUPER, ASParser.TOKEN_KEYWORD_SUPER)
            .put(IASKeywordConstants.THIS, ASParser.TOKEN_KEYWORD_THIS)
            .put(IASKeywordConstants.VOID, ASParser.TOKEN_KEYWORD_VOID)
            .put(IASKeywordConstants.RETURN, ASParser.TOKEN_KEYWORD_RETURN)
            .build();
            ...
            throws FileNotFoundException
    {
        ...
        for (final String filename : includedFiles)
        {
            imaginaryTokensBuilder.add(new ASToken(
                  ASParser.TOKEN_KEYWORD_INCLUDE,
                    0,
                    0,
                    0,
                    0,
            ...
            )
    {
        ...
        tokenizer.lastToken = new ASToken(ASParser.TOKEN_OPERATOR_ASSIGNMENT, -1, -1, -1, -1, "=");
        ...
        try
        {
            ...
            switch (tokenType)
            {
                ...
                case ASParser.TOKEN_KEYWORD_INCLUDE:
                {
                    ...
                    if (!matches(token, ASParser.TOKEN_LITERAL_STRING))
                    {
                ...
                case ASParser.TOKEN_RESERVED_WORD_CONFIG:
                    if (matches(LT(1), ASParser.TOKEN_RESERVED_WORD_NAMESPACE))
                    { //we config namespace
                        retVal.setType(ASParser.TOKEN_RESERVED_WORD_CONFIG);
                        return retVal;
                    }
                ...
                case ASParser.HIDDEN_TOKEN_BUILTIN_NS:
                    if (matches(LT(1), ASParser.TOKEN_OPERATOR_NS_QUALIFIER))
                    { //we have public:: and this structure is not an annotation but a name ref
                        retVal.setType(ASParser.TOKEN_NAMESPACE_NAME);
                        return retVal;
                    }
                    retVal.setType(ASParser.TOKEN_NAMESPACE_ANNOTATION);
                    return retVal;
                ...
                case ASParser.TOKEN_MODIFIER_VIRTUAL:
                {
                    ...
                    if (nextToken != null)
                    {
                        switch (nextToken.getType())
                        {
                            ...
                            case ASParser.TOKEN_NAMESPACE_NAME:
                            case ASParser.HIDDEN_TOKEN_BUILTIN_NS:
                                return retVal;
                ...
                {
                    final ASToken token = LT(1);
                    if (matches(token, ASParser.TOKEN_RESERVED_WORD_EACH))
                    {
                ...
                case ASParser.TOKEN_KEYWORD_DEFAULT:
                {
                    ...
                    final boolean foundTokenNamespace = maybeNS != null &&
                                                        maybeNS.getType() == ASParser.TOKEN_RESERVED_WORD_NAMESPACE;
                    if (foundTokenNamespace)
                    {
                        final ASToken maybeXML = LT(1);
                        final boolean foundTokenXML = maybeXML != null &&
                                                      maybeXML.getType() == ASParser.TOKEN_IDENTIFIER &&
                        ...
                        retVal.setType(ASParser.TOKEN_DIRECTIVE_DEFAULT_XML);
                        consume(2);
                    }
                    return retVal;
                }
                case ASParser.TOKEN_KEYWORD_VOID:
                {
                    //check for void 0
                    final ASToken token = LT(1);
                    if (matches(token, ASParser.TOKEN_LITERAL_NUMBER) && ZERO.equals(token.getText()))
                    {
                        retVal.setType(ASParser.TOKEN_VOID_0);
                        combineText(retVal, token);
                        consume(1);
                    }
                    //check for void(0)
                    else if (matches(token, ASParser.TOKEN_PAREN_OPEN))
                    {
                        final ASToken zeroT = LT(2);
                        if (matches(zeroT, ASParser.TOKEN_LITERAL_NUMBER) && ZERO.equals(zeroT.getText()))
                        {
                            final ASToken closeParenT = LT(3);
                            if (matches(closeParenT, ASParser.TOKEN_PAREN_CLOSE))
                            {
                                combineText(retVal, token);
                ...
                case ASParser.HIDDEN_TOKEN_STAR_ASSIGNMENT:
                {
                    //this is to solve an ambiguous case, where we can't tell the difference between 
                    //var foo:*=null and foo *= null;
                    retVal.setType(ASParser.TOKEN_OPERATOR_STAR);
                    retVal.setEnd(retVal.getEnd() - 1);
                    retVal.setText("*");
                    //add the equals
                    final ASToken nextToken = tokenizer.buildToken(ASParser.TOKEN_OPERATOR_ASSIGNMENT,
    ...
    private void treatKeywordAsIdentifier(final ASToken token)
    {
        ...
        token.setType(ASParser.TOKEN_IDENTIFIER);
    }
    ...
    private final ASToken consumeMetadata(final ASToken startToken) throws Exception
    {
        ...
        while (true)
        {
            ...
            consume(1);
            if (next.getType() == ASParser.TOKEN_SQUARE_CLOSE)
            {
                break;
            }
        }
    ...
    private final boolean isUserDefinedNamespace(final ASToken token, final int lookaheadOffset) throws Exception
    {
        ...
        return token.getType() == ASParser.TOKEN_NAMESPACE_ANNOTATION || token.getType() == ASParser.TOKEN_NAMESPACE_NAME;
    }
    ...
    private final void processUserDefinedNamespace(final ASToken token, final int lookaheadOffset) throws Exception
    {
        ...
        if (token.matchesLine(nextToken))
        {
            ...
            if (nextToken.getType() == ASParser.TOKEN_IDENTIFIER)
            ...
            switch (nextToken.getType())
            {
                ...
                case ASParser.TOKEN_NAMESPACE_ANNOTATION:
                case ASParser.HIDDEN_TOKEN_BUILTIN_NS:
                    token.setType(ASParser.TOKEN_NAMESPACE_ANNOTATION);
                    return;
                case ASParser.TOKEN_OPERATOR_NS_QUALIFIER: //simple name with a :: binding after it.  has to be a NS
                    token.setType(ASParser.TOKEN_NAMESPACE_NAME);
                    return;
            }
            if (nextToken.getType() == ASParser.TOKEN_OPERATOR_MEMBER_ACCESS)
            {
                int nextValidPart = ASParser.TOKEN_IDENTIFIER;
                ...
                while (true)
                {
                    ...
                    if (token.matchesLine(nextToken))
                    {
                        ...
                        {
                            nextValidPart = (nextToken.getType() == ASParser.TOKEN_IDENTIFIER) ? ASParser.TOKEN_OPERATOR_MEMBER_ACCESS : ASParser.TOKEN_IDENTIFIER;
                            toTransform.add(nextToken);
                        }
                        else if (nextValidPart != ASParser.TOKEN_IDENTIFIER && nextToken.canFollowUserNamespace())
                        {
                            ...
                            {
                                if (ttToken.getType() == ASParser.TOKEN_IDENTIFIER)
                                    ttToken.setType(ASParser.TOKEN_NAMESPACE_ANNOTATION);
                                else
                                    ttToken.setType(ASParser.TOKEN_OPERATOR_MEMBER_ACCESS);
                            }
                            break;
                        }
                        else
