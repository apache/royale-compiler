...
abstract class BaseASParser extends LLkParser implements IProblemReporter
{
            ...
            final IncludeHandler includeHandler)
    {
        ...
        try
        {
            ...
            while (buffer.LA(1) != ASParser.EOF)
            ...
            final ConfigProcessor configProcessor)
    {
        ...
        try
        {
            ...
            ((BaseASParser)parser).blockDepth = 1;
            while (buffer.LA(1) != ASParser.EOF && buffer.LA(1) != ASParser.TOKEN_BLOCK_CLOSE)
                parser.directive(container, ASParser.TOKEN_BLOCK_CLOSE);
            problems.addAll(tokenizer.getTokenizationProblems());
            problems.addAll(parser.getSyntaxProblems());
        }
        catch (RecognitionException e)
    ...
    void addConfigConstNode(ConfigConstNode node)
    {
        ...
        if (node.getKeywordNode().getKeywordId() != ASParser.TOKEN_KEYWORD_CONST)
        {
    ...
    protected final void preCheckMetadata(Token attributeToken, ContainerNode container)
    {
        ...
        if (ASToken.isDefinitionKeyword(la) ||
            ...
            isConfigCondition() ||
            la == ASParser.TOKEN_NAMESPACE_ANNOTATION ||
            la == ASParser.TOKEN_ASDOC_COMMENT ||
            la == ASParser.TOKEN_ATTRIBUTE)
            return;
    ...
    {
        return LA(1) == ASParser.TOKEN_NAMESPACE_NAME &&
               LA(2) == ASParser.TOKEN_OPERATOR_NS_QUALIFIER &&
               LA(3) == ASParser.TOKEN_IDENTIFIER;
    }
    ...
    protected IdentifierNode handleMissingIdentifier(RecognitionException ex)
    {
        ...
        if (current.getType() == ASParser.TOKEN_RESERVED_WORD_EXTENDS)
        {
        ...
        else if (la2.getType() == ASParser.TOKEN_IDENTIFIER && la2.getLine() == current.getLine())
        {
    ...
    protected boolean handleParsingError(final RecognitionException ex, final int endToken)
    {
        ...
        if (current.getType() == ASParser.TOKEN_SEMICOLON)
    ...
    private boolean handleParsingError(final RecognitionException ex, final ASToken current, final ASToken errorToken, final int endToken)
    {
        ...
        if (current.getType() == ASParser.TOKEN_ASDOC_COMMENT)
        {
            consume();
            return true;
        }
    ...
    private boolean recoverFromRecognitionException(final RecognitionException ex, final ASToken nextToken)
    {
        ...
        if (nextToken.getType() == ASParser.EOF)
            return false;
        ...
        if (nextToken.isKeywordOrContextualReservedWord())
        {
            ...
            nextToken.setType(ASParser.TOKEN_IDENTIFIER);
            return true;
        }
        ...
        else if (nextToken.getType() == ASParser.TOKEN_SEMICOLON)
        {
    ...
    protected void endContainerAtError(RecognitionException ex, NodeBase node)
    {
        ...
        if (endToken == null || endToken.getType() == ASParser.EOF)
        {
    ...
    protected void consumeUntilKeywordOrIdentifier(int exitCondition)
    {
        consumeUntilKeywordOr(
                ASParser.TOKEN_IDENTIFIER,
                ASParser.TOKEN_ATTRIBUTE,
                ASParser.TOKEN_ASDOC_COMMENT,
                exitCondition);
    }
    ...
    private static final ImmutableMap<Integer, Integer> BINARY_PRECEDENCE =
            new ImmutableMap.Builder<Integer, Integer>()
                    .put(ASParser.TOKEN_COMMA, 1)
                    .put(ASParser.TOKEN_OPERATOR_ASSIGNMENT, 2)
                    .put(ASParser.TOKEN_OPERATOR_LOGICAL_AND_ASSIGNMENT, 2)
                    .put(ASParser.TOKEN_OPERATOR_LOGICAL_OR_ASSIGNMENT, 2)
                    .put(ASParser.TOKEN_OPERATOR_PLUS_ASSIGNMENT, 2)
                    .put(ASParser.TOKEN_OPERATOR_MINUS_ASSIGNMENT, 2)
                    .put(ASParser.TOKEN_OPERATOR_MULTIPLICATION_ASSIGNMENT, 2)
                    .put(ASParser.TOKEN_OPERATOR_DIVISION_ASSIGNMENT, 2)
                    .put(ASParser.TOKEN_OPERATOR_MODULO_ASSIGNMENT, 2)
                    .put(ASParser.TOKEN_OPERATOR_BITWISE_AND_ASSIGNMENT, 2)
                    .put(ASParser.TOKEN_OPERATOR_BITWISE_OR_ASSIGNMENT, 2)
                    .put(ASParser.TOKEN_OPERATOR_BITWISE_XOR_ASSIGNMENT, 2)
                    .put(ASParser.TOKEN_OPERATOR_BITWISE_LEFT_SHIFT_ASSIGNMENT, 2)
                    .put(ASParser.TOKEN_OPERATOR_BITWISE_RIGHT_SHIFT_ASSIGNMENT, 2)
                    .put(ASParser.TOKEN_OPERATOR_BITWISE_UNSIGNED_RIGHT_SHIFT_ASSIGNMENT, 2)
                    .put(ASParser.TOKEN_OPERATOR_TERNARY, 3)
                    .put(ASParser.TOKEN_OPERATOR_LOGICAL_OR, 4)
                    .put(ASParser.TOKEN_OPERATOR_LOGICAL_AND, 5)
                    .put(ASParser.TOKEN_OPERATOR_BITWISE_OR, 6)
                    .put(ASParser.TOKEN_OPERATOR_BITWISE_XOR, 7)
                    .put(ASParser.TOKEN_OPERATOR_BITWISE_AND, 8)
                    .put(ASParser.TOKEN_OPERATOR_EQUAL, 9)
                    .put(ASParser.TOKEN_OPERATOR_NOT_EQUAL, 9)
                    .put(ASParser.TOKEN_OPERATOR_STRICT_EQUAL, 9)
                    .put(ASParser.TOKEN_OPERATOR_STRICT_NOT_EQUAL, 9)
                    .put(ASParser.TOKEN_OPERATOR_GREATER_THAN, 10)
                    .put(ASParser.TOKEN_OPERATOR_GREATER_THAN_EQUALS, 10)
                    .put(ASParser.TOKEN_OPERATOR_LESS_THAN, 10)
                    .put(ASParser.TOKEN_OPERATOR_LESS_THAN_EQUALS, 10)
                    .put(ASParser.TOKEN_KEYWORD_INSTANCEOF, 10)
                    .put(ASParser.TOKEN_KEYWORD_IS, 10)
                    .put(ASParser.TOKEN_KEYWORD_AS, 10)
                    .put(ASParser.TOKEN_KEYWORD_IN, 10)
                    .put(ASParser.TOKEN_OPERATOR_BITWISE_LEFT_SHIFT, 11)
                    .put(ASParser.TOKEN_OPERATOR_BITWISE_RIGHT_SHIFT, 11)
                    .put(ASParser.TOKEN_OPERATOR_BITWISE_UNSIGNED_RIGHT_SHIFT, 11)
                    .put(ASParser.TOKEN_OPERATOR_MINUS, 12)
                    .put(ASParser.TOKEN_OPERATOR_PLUS, 12)
                    .put(ASParser.TOKEN_OPERATOR_DIVISION, 13)
                    .put(ASParser.TOKEN_OPERATOR_MODULO, 13)
                    .put(ASParser.TOKEN_OPERATOR_STAR, 13)
                    .build();
    ...
    private final int precedence(final ASToken op)
    {
        ...
        if (expressionMode == ExpressionMode.noIn && op.getType() == ASParser.TOKEN_KEYWORD_IN)
            return 0;
    ...
    protected boolean afterRestrictedToken(final ASToken current)
    {
        ...
        if (nextToken != null &&
            ...
            nextToken.getType() !=ASParser.TOKEN_SEMICOLON)
    ...
    private static final ImmutableSet<Integer> RESTRICTED_TOKEN_TYPES = ImmutableSet.of(
            ASParser.TOKEN_KEYWORD_RETURN,
            ASParser.TOKEN_KEYWORD_CONTINUE,
            ASParser.TOKEN_KEYWORD_BREAK,
            ASParser.TOKEN_KEYWORD_THROW);
    ...
    protected boolean beforeRestrictedToken(final ASToken nextToken)
    {
        ...
        assert nextToken.getType() == ASParser.TOKEN_OPERATOR_INCREMENT ||
               nextToken.getType() == ASParser.TOKEN_OPERATOR_DECREMENT : "Unexpected restricted token type: " + nextToken.getTypeString();
    ...
    protected final void recoverFromExpressionStatementMissingSemicolon(final ExpressionNodeBase e)
    {
        ...
        if (e instanceof IdentifierNode)
        {
            ...
            {
                if (lt.getType() == ASParser.TOKEN_KEYWORD_PACKAGE)
                {
        ...
        else if (lt.getType() == ASParser.TOKEN_COLON)
        {
            ...
            final String configVar)
    {
        ...
        return value != null && ECMASupport.toBoolean(value);
    }
    ...
    protected final void skipFunctionBody(final FunctionNode functionNode, final ASToken openT)
    {
        ...
        assert openT != null && openT.getType() == ASParser.TOKEN_BLOCK_OPEN : "Expected '{' token";
        ...
        if (LA(1) == ASParser.TOKEN_BLOCK_CLOSE || LA(1) == ASParser.EOF)
            return;
        ...
        tokenLoop:
        for (int depth = 0; depth > 0 || LA(1) != ASParser.TOKEN_BLOCK_CLOSE; consume())
        {
            prevToken = LT(1);
        ...
        assert LA(1) == ASParser.TOKEN_BLOCK_CLOSE || LA(1) == ASParser.EOF : "Loop should stop before the '}' of the function body or 'eof'.";
            ...
            final ASToken lastToken)
    {
        ...
        if (secondaryReader != null && !functionBodyHasInclude)
        {
            ...
            try
            {
                ...
                if (LA(1) == ASParser.TOKEN_BLOCK_CLOSE)
                    endToken = LT(1);
                else
                    endToken = lastToken;
    ...
    {
        return LA(1) == ASParser.TOKEN_KEYWORD_FUNCTION && (LA(2) == ASParser.TOKEN_PAREN_OPEN || buffer.previous().canPreceedAnonymousFunction());
    }
    ...
    protected final void recoverFromMetadataTag(final ContainerNode container, final ArrayLiteralNode arrayLiteralNode)
    {
        ...
        if (lookback != null &&
            lookback.getType() == ASParser.TOKEN_IDENTIFIER &&
            lookback.getText().equals(IASKeywordConstants.VAR))
        {
            lookback.setType(ASParser.TOKEN_KEYWORD_VAR);
    ...
    {
        if (LA(1) == ASParser.TOKEN_SQUARE_OPEN &&
    ...
    {
        assert token.getType() == ASParser.TOKEN_E4X_OPEN_TAG_START : "unexpected token type: " + token;
    ...
    {
        assert token.getType() == ASParser.HIDDEN_TOKEN_E4X : "unexpected token " + token;
    ...
    {
        assert token.getType() == ASParser.TOKEN_E4X_CLOSE_TAG_START : "unexpected token " + token;
        assert token.getText().startsWith("</") : "unexpected token text: " + token;
    ...
    {
        assert token.getType() == ASParser.TOKEN_E4X_EMPTY_TAG_END : "unexpected token " + token;
    ...
    protected final boolean isNextTokenPublicNamespace()
    {
        ...
        return ASParser.TOKEN_NAMESPACE_ANNOTATION == token.getType() &&
    ...
    {
        while (LA(1) != ASParser.EOF)
        {
            fileLevelDirectives(c);
            if (LA(1) != ASParser.EOF)
            {
