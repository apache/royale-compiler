...
public class CSSSelectorTests extends CSSBaseTests {
	...
	{
		ImmutableList<ICSSSelector> combinedSelectors1 = CSSSelector.getCombinedSelectorList( getCSSFirstSelector("s|Label .test #Name") );
		...
		ImmutableList<ICSSSelector> combinedSelectors3 = CSSSelector.getCombinedSelectorList( getCSSFirstSelector("s|Label") );
